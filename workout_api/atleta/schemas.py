...
class Atleta(BaseSchema):
    nome: Annotated[str, Field(description="Nome do atleta", example="Luan", max_length=50)]
...
class AtletaUpdate(BaseSchema):
    nome: Annotated[Optional[str], Field(None, description="Nome do atleta", example="Luan", max_length=50)]
